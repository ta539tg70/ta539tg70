...
<details>
    ...
    他社から買収したサービスのエンハンス開発。特段引き継ぎなどを受けたわけでもなかったため実装意図の分からないコードが数多くあったが、スパゲティコードを読み解くというエンジニアとして大切なスキルを習得。
</details>
...
<details>
    ...
    これまでも携わっていたtoBオークションシステムのチームで長期サマーインターン生の受け入れを行うことになり、メインメンターとして運営をリード。クレジットカード決済機能の組み込みをテーマに、説明会の実施や下調べ、当日のインターン生のOJTを行なった。
</details>
