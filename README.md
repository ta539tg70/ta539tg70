...
<details>
    ...
    会社の基幹システムの開発。<br />
    与えられたタスクをこなしながら先輩エンジニアからのレビューコメントで学びを得て、自分の技術力を磨く日々。
</details>
...
<details>
    ...
    それまで利用していたSalesforceから脱却し、新たに開発した内製顧客管理システムへデータを移行するための既存データ加工システムの実装。莫大なデータがあったためパフォーマンスも意識した開発を行った。
</details>
...
<details>
    ...
    これまでも携わっていたtoBオークションシステムのチームで長期サマーインターン生の受け入れを行うことになり、メインメンターとして運営をリード。当日取り組んでもらう課題を決めるところから参画。クレジットカード決済機能の組み込みをテーマに、設計の下準備に注力した。（いきなりインターン生に答えを与えすぎないよう配慮しつつ、放任しすぎてとんでもない方向に進んでいってしまわないようこちらで予め大枠の実装方針を決めておいた）他にも説明会の実施や書類選考、当日のインターン生のOJTを行なった。
</details>
