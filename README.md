...
- [技術スタック](#技術スタック)
- [自己PR](#自己pr)
  - [ヒアリング力・物事の本質を見極める力](#ヒアリング力物事の本質を見極める力)
  - [先を見越して、今何が必要か考える力](#先を見越して今何が必要か考える力)
  - [仕事で遊ぶマインドセット](#仕事で遊ぶマインドセット)
- [職務経歴](#職務経歴)
...
要件定義→実開発〜テスト→リリース後の運用保守および効果測定まで一貫して開発に携わってきた。少人数でスピード感と安定感のバランスを取りながら、開発メンバーだけでなくビジネス側のチームメンバーとも共にサービス・組織をリードしていくことができる。  
プロジェクトを推進するために必要なことは役割に捉われずなんでも実行してきた。制度ややり方が整っていない中で「[なんかいい感じ](https://everyday.mof-mof.co.jp/entry/2022/01/19/183308)」に着地させることができるのが強み。
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>TypeScript, Next.js, React, Vue.js, HTML/CSS, MUI, Storybook</td>
    </tr>
    <tr>
      <th scope="row">インフラ</th>
      <td>Docker, AWS, Google Cloud, SAM</td>
    </tr>
    <tr>
...
<img src="./image.png" alt="顧客が本当に必要だったもの" width="500" /><br />
上記の絵で揶揄されたり「ドリルの穴理論」で説かれたりするように、ユーザーが言葉にする「これが欲しい」をそのまま鵜呑みにするのは危険である。「なぜそうなのか」を常に考え、根気強くヒアリングし、物事の本質・根本課題にアプローチする姿勢をとても大切にしている。  
私はエンジニアになる前は広告業界におり、Photoshopを使って街頭広告や映画ポスターを制作する「レタッチャー」という仕事に5年ほど従事していた。アート要素の強い仕事であったため、お客様の要望も「なんとなくカッコ良い感じに」など曖昧になりがち。そんな中、「なんとなくカッコ良い」とはつまりどういうことなのか、入念なヒアリングを通して相手の要望を具現化・明確化することが必要不可欠だったことが、今のエンジニアとしての人生にも活きていると感じている。

## 先を見越して、今何が必要か考える力

「〇〇を△日までに達成しなければいけないから、ブロッカーとなり得る××は先に片付けておこう」といったように、転ばぬ先の杖的な動きを常に意識している。  
例えば「テストの実施」という行為をひとつとっても、その中には「テストケースの作成」「テストケースの実施」「テスト結果を受けての修正」「再テストの実施」という最低4つのステップがあり、基本的に1日では終わらない。けれど表現する時は「テスト」になる。字面には表れない隙間の作業を具体的にイメージし、その工数も考慮して計画を立て、事前に手を打てるものは打っておくことで、スケジュール遅延を軽減したり、ボトルネックを作らずリソースを無駄なく活用することができる。  
特にPjMという役割はこれを意識し行動できているかでプロジェクトの成功を大きく左右すると思っており、実際過去に自分が主担当だったプロジェクトにおいてスケジュール遅延やリリース後の問題が発生したケースはほとんどない。

## 仕事で遊ぶマインドセット

私は趣味＝仕事のタイプであるため、「楽しく仕事したい」という大前提がある。しばしば辛いことや嫌なことにも遭遇するが、それに対して愚痴を言うだけでなく、その状況をいかに楽しむか・どうやったら遊びに変えられるかを考えながら生きている。  
以前この考え方をテーマに簡単なプレゼンを行ったことがあるため、当時の資料を参照されたい。→[仕事での遊び方](https://docs.google.com/presentation/d/1X-F78qcp0Eo9dh61dOAm3q1cztFkmXVHGTXSb5hXs1s/edit?usp=sharing)
...
<details>
    ...
    初めてEMというポジションに着いてから半年後、掛け持ちで2チーム目を見ることになった。前任が退職するにあたり後任としてこの役目を担うことになったが、自分の就任2ヶ月後にはリリースを控えているプロダクトであった。チームの規模も大きくなった上に使用技術もこれまで携わってきたプロダクトと大きく違うし、更に掛け持ちということで自分のキャパシティ的に大丈夫か不安もあったが、これまで数多くのプロジェクトを経験してきたことによって培われてきたキャッチアップ力を存分に発揮できたと思う。早い段階からチームの議論にも参加することができるようになり、エンジニアチーム内だけでなくビジネスサイドの信頼も得てリリース当日を乗り切ることができた。
</details>
...
<details>
    ...
    業務委託とも定期的に1on1を実施し、モチベーション管理・契約管理を通じてチーム全体が常に良いコンディションで機能するよう配慮した。<br />
    「自分がEMとしてどうだったか」はなかなか部下本人からフィードバックを得られる機会は少ないが、自分としては内省をしながら改めて自身の得手不得手を再確認することができ、多くの学びを得ながらより広い視野で物事を捉えることができるようになったと感じている。
</details>
...
<details>
    ...
    自分が工夫して動いてボトルネックを解消することで、自身の焦りが緩和されるだけでなく、短い納期であったがリリース目標も守ることができた。また、年末に行われる社内表彰式でアワードを受賞した。
</details>
